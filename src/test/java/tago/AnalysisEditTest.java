...
public class AnalysisEditTest {
    
    public AnalysisEditTest() {
    }
    ...
    public void test() {
        ...
        account.analysis.id = acr.result.id;
        account.analysis.name = "Edited JAVA SDK test Analysis";
        account.analysis.description = "Edited by JAVA SDK test Analysis";
        
        AnalysisCreateResult ae = account.analysis.edit(account.analysis);
